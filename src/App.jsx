...
useEffect(() =>{
  ...
  //this returns a function but this is not re executed again when this is called again and again just like we are entering to the
  //infinite loop when the onConfirm is sent as an argument 
  //by useCallback its that the function is not recreated but its stored internally into the memory and reuses the stored function 
